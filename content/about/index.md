...
🚩 **\_\_init\_\_ 스쿼드**는 유저의 프로그래밍 공부를 처음부터 끝까지 책임지기 위해 모인 그룹으로, 코드당의 강의 기능을 기획, 개발 및 유지해요. 25-2학기 기준, 코드당의 Course에서는 이한국 교수님의 '자료구조개론'과 김준기 교수님의 '공학컴퓨터프로그래밍' 강의가 진행되고 있어요!
