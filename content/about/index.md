...
- 모든 동아리원들이 참여하여 친해질 수 있는 행사(워크샵, MT, 해커톤)을 주기적으로 진행해요.
  {{< figure src="2024년 12월 워크샵.jpg" width="480" caption="2024년 12월 워크샵.jpg" alt="2024년 12월 워크샵.jpg" >}}
...
- 개발팀이 올려준 코드들이 쉽고 빠르게 적용될 수 있도록 CD 파이프라인으로 자동화된 배포를 지원해요.
- 서버 및 여러 환경 관리를 자동화하여 인력이 효율적으로 쓰일 수 있도록 도와줘요.
- 모니터링 시스템(Grafana)을 구축하여 안정성을 확보해요.
- 사용하고 있는 기술은 AWS(EC2, S3, Cloudfront, ECS, RDS, ElastCache, MQ 등), Grafana, Kubernetes, Terraform, Github Action 등이 있어요.
...
- 성과 : 사용자 유입 경로의 다변화를 위해 Contest 기능을 개발하였고, 지난 5월 소프트웨어학과 학생회, NPC와 함께 프로그래밍 대회를 개최했어요.
- 진행중인 작업 : 현재는 Contest 내 Q&A 기능 고도화 작업 및 PS 문제 생성 서비스를 개발 중이에요.

🚩 **\_\_init\_\_ 스쿼드**는 유저의 프로그래밍 공부를 처음부터 끝까지 책임지기 위해 모인 그룹으로, 코드당의 강의 기능을 기획, 개발 및 유지해요. 25-2학기 기준, 코드당의 Course에서는 이한국 교수님의 '자료구조개론'과 김준기 교수님의 '공학컴퓨터프로그래밍' 강의를 진행했어요!

- 구성: 기획 2명 / 디자인 1명 / 프론트 7명 / 백엔드 6명, 총 16명의 인원으로 구성되어 있어요.
...
- 진행중인 작업 : 현재는 강의 지원 기능을 유지·보수하면서, 실시간으로 문제를 풀고 코드와 피드백을 공유하는 스터디 그룹 기능을 개발 중이에요.
...
(기획, 디자인팀의 경우 팀별 상의를 통해 원하는 장소에서 진행될 수 있어요. 저번 학기에는 명륜 스터디룸을 빌려서 진행했어요!)
...
[2026-1 SKKUDING 모집 지원](https://tally.so/r/ZjNXgz)
...
**Q. 캠퍼스 별로 회비 금액이 다른 이유는 무엇인가요?**

> A. 저희 동아리는 자연과학캠퍼스 제2공학관 26B13에 위치하고 있어요.
> 인문사회과학캠퍼스 소속 부원들은 동아리방을 이용할 일이 적을 수 밖에 없기 때문에 형평성을 고려하여 회비를 다르게 걷고 있어요.
> 하지만 스꾸딩에서 주관하는 여러 행사나 기타 지원 등을 통해 최대한 모든 부원들이 동등한 혜택을 누릴 수 있도록 노력하고 있으니 걱정하지 마세요!
