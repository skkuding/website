...
SKKUDING(스꾸딩)은 SKKU와 coding을 합친 이름으로, [Codedang(코드당) 웹사이트](https://codedang.com) 개발 프로젝트를 주도적으로 진행하는 프로젝트 팀이에요. 2020년 알고리즘 동아리인 NPC 소속 개발팀에서 처음 시작하여 2022년 1학기에 공식적으로 독립된 동아리로 분리되었습니다.
...
스터디는 스꾸딩의 스터디 Cookbook을 활용해요. 총 8주간 진행하고, Cookbook의 가이드를 따라 팀별로 스터디를 진행해요. 기획/디자인 팀은 스터디와 프로젝트 참여가 동시에 이루어져요.
...
| ----- | ----------------- | ------------------- | ----------------------- | ------------------------------------------- |
| 1주차 | HTML, CSS         | Node.js             | Node.js                 | 도메인 이해 및 IA 설계                      |
| 2주차 | JavaScript        | Express.js          | Express.js              | 와이어프레임 설계                           |
| 3주차 | TypeScript        | TypeScript          | Docker                  | 프로젝트 관리 방법론 및 이슈 트래커         |
| 4주차 | React             | NestJS (1)          | AWS EC2, Network        | 서비스 기획 및 디자인 기초                  |
| 5주차 | REST API, GraphQL | NestJS (2)          | AWS S3, Cloudfront, IAM | [1차 스프린트] 유저 인터뷰 (관리자 측)      |
| 6주차 | Tailwind CSS      | Prisma              | AWS ELB, ECR, ECS       | [1차 스프린트] 화면 구현 및 기능명세서 작성 |
| 7주차 | React Ecosystem   | GraphQL             | Terraform               | [2차 스프린트] 유저 설문조사 (사용자 측)    |
| 8주차 | Next.js           | Testing (Unit, E2E) | GitHub Action           | [2차 스프린트] 화면 구현 및 기능명세서 작성 |
...
<!-- [2024-2 SKKUDING 팀원 모집](https://tally.so/r/nP5ZRx) -->
